...
<head>
  ...
  <title> <?php include_once('includes/configsys.php'); echo $comp_name;?> | Login Page</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4" style="margin-top: 2%">
            <h1 class="h3 mb-0 text-gray-800"><?php echo $comp_name; ?> EMPLOYEE RECORD MANAGEMENT SYSTEM</h1>
          </div>
