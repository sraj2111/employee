...
<head>
  ...
  <meta name="viewport" content="Employee Record management System ">
  <meta name="description" content="Employee Record management System of  ">
  <meta name="author" content="">

  <title> <?php include('includes/configsys.php'); echo $comp_name;?> EMPLOYEE LOGIN</title>
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    ...
    echo $msg;
                  ...
                  <form class="user" method="post" action="">
                    ...
                    <div class="form-group">
                      <button type="button" id="fill" class="btn btn-success btn-user btn-block success">Fill Detail</button>
                    </div>
  ...
  <script>
// Input for the Auto fill function
